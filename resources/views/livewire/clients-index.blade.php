        ...
        <table class="min-w-full divide-y divide-gray-300">
            ...
            @foreach($clients as $client)
                <tr>
                    ...
                    <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 sm:table-cell">{{ $client->phone_number }}</td>
                    ...
                    <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="{{ route('client.show', $client) }}" class="text-tkd-blue-600 hover:text-tkd-blue-900">View<span class="sr-only">, Lindsay Walton</span></a>
                    </td>
                </tr>
            @endforeach
            </tbody>

    ...
    <div class="flex justify-end">
        <div class="w-1/4">
            <div class="relative mt-1 flex items-center">
                ...
                <input wire:model="search" type="search" name="search" id="search" placeholder="Search Clients" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm">
            </div>
        </div>
    </div>

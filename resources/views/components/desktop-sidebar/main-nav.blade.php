...
<a href="{{ route('dashboard') }}" class="{{ (request()->is('clients/*')) ? 'bg-slate-800' : '' }} text-white hover:text-white hover:bg-slate-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md" aria-current="page">
    <!-- Heroicon name: outline/home -->
    <svg xmlns="http://www.w3.org/2000/svg" class="mr-4 flex-shrink-0 h-6 w-6 text-slate-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
